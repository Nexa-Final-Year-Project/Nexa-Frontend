...
import { ArrowLeft, Search, Keyboard, Monitor, Command } from "lucide-react";
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  >
                    <span className="text-emerald-500 font-medium">Ctrl</span> =
                    Windows/Linux
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    anywhere in the app to instantly search projects, tasks,
                    team members, and more. It's the fastest way to navigate.
                  </p>
                  <div className="flex items-center gap-4 text-sm">
                    <span
                      className={isDark ? "text-white/40" : "text-neutral-500"}
                    >
                      Try searching for:
                    </span>
                    <span
