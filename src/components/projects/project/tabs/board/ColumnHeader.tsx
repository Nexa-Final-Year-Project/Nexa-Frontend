...
const columnGradients: Record<string, { from: string; to: string; glow: string }> = {
  "Backlog": { from: "from-slate-500", to: "to-slate-600", glow: "rgba(100,116,139,0.4)" },
  "Todo": { from: "from-blue-500", to: "to-cyan-500", glow: "rgba(59,130,246,0.4)" },
  "In Progress": { from: "from-amber-500", to: "to-orange-500", glow: "rgba(245,158,11,0.4)" },
  "Done": { from: "from-emerald-500", to: "to-green-500", glow: "rgba(16,185,129,0.4)" },
  "Blocked": { from: "from-red-500", to: "to-rose-500", glow: "rgba(239,68,68,0.4)" },
};
