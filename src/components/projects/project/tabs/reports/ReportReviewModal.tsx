        ...
        <div className="flex items-center justify-between px-6 py-3 bg-slate-900/80 border-b border-slate-800 text-slate-50 z-10">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-2 bg-neutral-700 text-neutral-100 rounded hover:bg-neutral-600"
            >
              Approve
            </button>
            <button
            ...
            <button
              onClick={saveDraft}
              className="px-3 py-2 border border-neutral-700 rounded text-neutral-200"
            >
              Save
            </button>
            <button
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="p-4 rounded bg-slate-800/50 backdrop-blur-sm border border-slate-700">
                ...
                <div className="mt-3">
                  <Sparkline
                    values={[
                      meta?.sprintHealthScore || 0,
                      (meta?.sprintHealthScore || 0) + 1,
                      (meta?.sprintHealthScore || 0) - 1,
                      (meta?.sprintHealthScore || 0) + 2,
                    ]}
                  />
                </div>
              </div>
            ...
            <div className="p-4 rounded bg-slate-800/50 border border-slate-700 text-slate-100">
              ...
              {Object.entries(taskDistribution).map(([role, count]) => (
                <div key={role} className="flex items-center gap-3 mb-2">
                  ...
                  <div className="w-8 text-sm text-slate-300 text-right">
                    {count}
                  </div>
                </div>
              ))}
            ...
            <section>
              ...
              <div className="rounded max-h-60 overflow-y-auto bg-slate-900/30 border border-slate-700 p-2">
                      ...
                      <li key={i} className="p-3 flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-2">
                          <button
                            onClick={() => {
                              setDecisionLog(
                                decisionLog.filter((_, idx) => idx !== i)
                              );
                            }}
                ...
                <div className="p-3">
                  <button
                    onClick={() =>
                      setDecisionLog(["New suggested task", ...decisionLog])
                    }
