...
import { EllipsisVerticalIcon, FolderOpen, Sparkles, ArrowRight } from "lucide-react";
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          `}>
            <FolderOpen className={isDark ? "w-4 h-4 text-white/60" : "w-4 h-4 text-neutral-500"} />
          </div>
          <div>
            <h2 className={`text-lg font-semibold ${isDark ? "text-white" : "text-neutral-900"}`}>Recent Projects</h2>
            <p className={`text-xs ${isDark ? "text-white/40" : "text-neutral-500"}`}>Quick access to your latest work</p>
          </div>
        </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button 
                ...
                `}
              >
                <EllipsisVerticalIcon className={isDark ? "w-4 h-4 text-white/60" : "w-4 h-4 text-neutral-500"} />
              </Button>
            </DropdownMenuTrigger>
            ...
            `}>
              <DropdownMenuItem 
                ...
                `}
              >
                <Sparkles className={isDark ? "w-4 h-4 text-white/50" : "w-4 h-4 text-neutral-400"} />
                Create Project
              </DropdownMenuItem>
              <DropdownMenuItem 
                onClick={handleViewAllProjects}
                ...
                `}
              >
                <FolderOpen className={isDark ? "w-4 h-4 text-white/50" : "w-4 h-4 text-neutral-400"} />
                View All Projects
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
