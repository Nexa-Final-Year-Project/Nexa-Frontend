...
import { useDeleteAccountMutation, useResetDataMutation } from "@/api/auth/authApi";
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            Your account will remain active but completely empty. This action cannot be undone.
          </AlertDialogDescription>
        </AlertDialogHeader>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-4">
            ...
            <span className="block font-semibold">Type "DELETE" to confirm:</span>
            <input
              type="text"
              value={deleteConfirm}
