...
const stats = [
  {
    ...
    description: "Average improvement in project delivery time",
  },
  {
    value: "3.2x",
    label: "Team Productivity",
    description: "Increase in tasks completed per sprint",
  },
  {
    value: "89%",
    label: "Accuracy",
    description: "AI estimation accuracy for story points",
  },
  {
    value: "62%",
    label: "Less Meetings",
    description: "Reduction in status update meetings",
  },
];
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div
          className={`absolute inset-0 ${
            isDark
              ? "bg-gradient-to-b from-[#0a0a0f] via-violet-950/10 to-[#0a0a0f]"
              : "bg-gradient-to-b from-white via-violet-50/50 to-white"
          }`}
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Real metrics from teams using NEXA to transform their project
            management workflow.
          </p>
        </motion.div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <p className={`${isDark ? "text-white/50" : "text-neutral-600"}`}>
                Monitor your team's performance with beautiful, actionable
